...
public class ClienteDao extends GenericDao<Cliente, Long> implements IClienteDao {
    ...
    @Override
    public Cliente consultar(Serializable valor) throws MaisDeUmRegistroException, TableException, DaoException {
        return null;
    }

    @Override
    public void excluir(Serializable valor) throws DaoException {
